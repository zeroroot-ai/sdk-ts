...
// 12 services, 189 RPCs. Run `pnpm generate` at the workspace root
...
export const GENERATED_SERVICES: GeneratedServiceDoc[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      { method: "watchComponentEvents", description: "WatchComponentEvents streams lifecycle events for the calling component: secret_access_revoked and secret_rotated. The daemon takes the component from the caller's identity; the request names nothing, so a caller cannot watch another component. The stream stays open until the client cancels." },
...
export const GENERATED_RPC_COUNT = 189
